 ...
 * @author Iruzzend
 */
public class quizzaki extends javax.swing.JFrame {

    /**
     * Creates new form quizzaki
     */
    public quizzaki() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtnilai.setToolTipText("Masukkan Nilai");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtnilai.isEmpty) || (txtnama.isEmpty){
...
• - Nilai di bawah 50: E
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(quizzaki.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
